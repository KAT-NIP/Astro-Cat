Thank you for downloading Crow.

This is a 3d model and animations of a Crow. 

-Animations folder contains FBX files of animations.
Walk and hop animations are compatible with root motion.
...
Demo folder contains an example use of the Crow model. 
